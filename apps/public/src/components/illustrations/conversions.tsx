...
const idnPoints = [28, 31, 29, 34, 32, 36, 35, 38, 37, 40, 39, 42];
const showroomPoints = [28, 30, 32, 35, 38, 37, 40, 42, 44, 43, 47, 50];

export function LiveStreamIllustration() {
  return (
    <div className="h-full col gap-3 px-4 pb-3 pt-5">
      ...
      <div className="row gap-3">
        <div className="col flex-1 gap-1 rounded-xl border bg-card p-3 transition-all duration-300 group-hover:-translate-y-0.5">
          ...
          <span className="font-bold font-mono text-xl">28.4K</span>
          <SimpleChart
            height={24}
            points={idnPoints}
      ...
      <div className="col gap-1 rounded-xl border bg-card/60 px-3 py-2.5">
        ...
        <div className="row items-center gap-2">
          ...
          <span className="text-[9px] text-muted-foreground">IDN: 57%</span>
        </div>
        <div className="row items-center gap-2">
          <div className="h-1 flex-1 rounded-full bg-muted">
            <div
          ...
          <span className="text-[9px] text-muted-foreground">SR: 82%</span>
        </div>
      </div>
    </div>
  );
